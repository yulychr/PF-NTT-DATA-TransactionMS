...
import com.corebank.TransactionMS.controller.TransactionController;
...
class TransactionMsApplicationTests {
	...
	void setUp(ApplicationContext context) {
		...
		client = WebTestClient.bindToController(new TransactionController(transactionService,transactionRepository))
				.build();
